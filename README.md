# FL0 Hack Telegram Bot

Telegram-бот, который позиционируется как сервис "хакеров", взломавших приложение FL0. За 50 рублей пользователь может "узнать данные о дате овуляции" любой девушки по номеру ее телефона.
...
Репозиторий: https://github.com/SinArtur/Flo.git
